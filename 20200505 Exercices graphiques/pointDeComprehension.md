...
C'est à dire que this.starX = width + 5 seulement si on ne donne rien en paramètre.
Ici on donne à new Star dans le constucteur le paramètre random(w) pour que l'étoile soit déssiner avec un x aléatoire la première fois.
